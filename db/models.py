...
def _utcnow() -> datetime:
    ...
    All datetime columns below map to Postgres TIMESTAMP WITH TIME ZONE.
    sqlmodel 0.0.4x enforces this at write time (UTCDateTime.process_bind_param
    raises ValueError on a naive datetime) — see OPERATIONS.md for the
    2026-09-22 regression this fixes.
    """
